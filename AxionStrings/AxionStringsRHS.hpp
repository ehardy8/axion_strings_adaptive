...
// Placeholder RHS carried over unmodified from the GRTeclyn KleinGordon
// example (milestone-1 task 1.1: build/run baseline under the new name).
// Replaced by the complex-scalar c(tau) RHS of conventions.md sec.3 in
// task 1.3.
...
class AxionStringsRHS
{
  public:
    ...
    AxionStringsRHS(amrex::Real a_dx, model_t a_model)
